class viz(object):
    ...
    def forecastVizLOCS(self):
        ...
        for target in ["cases","deaths","hosps", "googles"]:
    ...
    def forecastVizLOCSCounty(self):
        import matplotlib.pyplot as plt
        import seaborn as sns
        import pandas as pd
        import numpy as np
        ...
        for col, target in zip(["county_cases","state_deaths","state_hosps", "county_googles"],["cases","deaths","hosps", "googles"]):
